...
from nengo.neurons import LIF, NeuronTypeParam, Population
...
class Neurons(object):
    ...
    @property
    def size_in(self):
        if isinstance(self.ensemble.neuron_type, Population):
            # This prevents users from connecting/probing Population neurons
