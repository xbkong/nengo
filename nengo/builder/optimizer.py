...
class OpMergeOptimizer(object):
    ...
    def __init__(self, model, dg):
        ...
        self._sig2op = None  # Internal dict mapping Signals to Operators
                             # accessing those signals.
        self._merged = None  # Internal set of Operators merged during the
    ...
    def _perform_single_pass(self, only_merge_ops_with_view):
        """Perform a signle optimization pass.
